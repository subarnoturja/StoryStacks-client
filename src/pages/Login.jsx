      ...
      <div className="grid justify-center max-w-md mx-auto">
        ...
        >
          ...
          <div className="mt-12">
            <button
              type="submit"
              className="btn w-full py-2.5 px-4 text-sm font-semibold tracking-wider rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none"
            >
              Sign in
            </button>
          ...
          <div className="space-x-6 flex justify-center">
            <button
              ...
              className="btn border w-full border-none outline-none"
            >
              <FcGoogle
              className="text-4xl"></FcGoogle>
              <p>Sign Up Google</p>
            </button>
          </div>
        </form>
